...
# #思路按照之前的双流模型方法 先将分类结果保存到excle中，然后再获取xgboost 最后进行融合
#
...
#
#     # 创建DataFrame来存储结果
#     results_df = pd.DataFrame(columns=["Image Name", "Predicted Class", "Confidence", "Timestamp"])
#
#     # 定义预处理
...
#     # 配置参数
#     img_size = 224  # B0模型
#     input_folder = r"D:\waibao\cancer_detect\data_model1\train\label1"  # 修改为输入文件夹路径
...
def main():
    ...
    output_folder = r"D:\waibao\cancer_detect\data_model1\predictimage"  # 修改为输出文件夹路径
    correction_file = r"D:\waibao\cancer_detect\gndexdata.xlsx"
